...
exports.Tag = React.forwardRef(function (props, ref) {
    var _a;
    var children = props.children, className = props.className, fill = props.fill, icon = props.icon, intent = props.intent, interactive = props.interactive, large = props.large, minimal = props.minimal, multiline = props.multiline, onRemove = props.onRemove, rightIcon = props.rightIcon, round = props.round, _b = props.tabIndex, tabIndex = _b === void 0 ? 0 : _b, htmlTitle = props.htmlTitle, htmlProps = tslib_1.__rest(props, ["children", "className", "fill", "icon", "intent", "interactive", "large", "minimal", "multiline", "onRemove", "rightIcon", "round", "tabIndex", "htmlTitle"]);
    ...
    var _c = (0, useInteractiveAttributes_1.useInteractiveAttributes)(isInteractive, props, ref, {
        defaultTabIndex: 0,
