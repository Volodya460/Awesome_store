...
var PanelView2 = function (_a) {
    var panel = _a.panel, onClose = _a.onClose, onOpen = _a.onOpen, previousPanel = _a.previousPanel, showHeader = _a.showHeader;
    ...
    var maybeBackButton = previousPanel === undefined ? null : (React.createElement(buttons_1.Button, { "aria-label": "Back", className: common_1.Classes.PANEL_STACK2_HEADER_BACK, icon: "chevron-left", minimal: true, onClick: handleClose, small: true, text: previousPanel.title, title: previousPanel.htmlTitle }));
    ...
    var PanelWrapper = React.useMemo(function () { return function () {
        ...
        return panel.renderPanel(tslib_1.__assign({ closePanel: handleClose, openPanel: onOpen }, panel.props));
    }; }, [panel, handleClose, onOpen]);
    return (React.createElement("div", { className: common_1.Classes.PANEL_STACK2_VIEW },
        showHeader && (React.createElement("div", { className: common_1.Classes.PANEL_STACK2_HEADER },
            React.createElement("span", null, maybeBackButton),
            React.createElement(text_1.Text, { className: common_1.Classes.HEADING, ellipsize: true, title: panel.htmlTitle }, panel.title),
