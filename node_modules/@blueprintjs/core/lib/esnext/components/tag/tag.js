...
export const Tag = React.forwardRef((props, ref) => {
    const { children, className, fill, icon, intent, interactive, large, minimal, multiline, onRemove, rightIcon, round, tabIndex = 0, htmlTitle, ...htmlProps } = props;
    ...
    return (React.createElement("span", { ...removeNonHTMLProps(htmlProps), ...interactiveProps, className: tagClasses },
        ...
        isRemovable && React.createElement(TagRemoveButton, { ...props })));
});
Tag.defaultProps = {
    active: false,
    fill: false,
