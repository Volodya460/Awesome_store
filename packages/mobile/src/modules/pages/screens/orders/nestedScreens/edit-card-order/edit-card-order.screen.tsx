...
import { styles } from '../../../products/nestedScreens/product-inf/product-inf.screen.styles';
...
export const EditCardOrder = ({ navigation }: EditCartProps) => {
	...
	const delivery_status = route.params?.order_detail_id;
	...
	const handleUpdate = async () => {
		await updateCartItem(id, { quantity: amount });
		...
		<Layout>
			<View style={styles.cardBox}>
				<View>
					...
					<Pressable
						onPress={
							isDeleteDisabled ? undefined : () => deleteItem(id)
						}
						disabled={isDeleteDisabled}
						style={isDeleteDisabled ? styles.disabled : undefined}
					>
						<Text style={styles.textDelete}>Remove from order</Text>
					</Pressable>
				</View>
				<Button
					title="Save"
